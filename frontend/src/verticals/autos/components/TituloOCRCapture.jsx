                ...
                return (
                  <div
                    ...
                    className={clsx(
                      ...
                      valor ? 'border-gray-200 bg-gray-50' : 'border-dashed border-gray-300',
                      campo.info && 'bg-blue-50 border-blue-200'
                    )}
                  >
                    <div className="flex items-center gap-3">
                      <Icon className={clsx(
                        'w-5 h-5 flex-shrink-0',
                        valor ? 'text-gray-600' : 'text-gray-400',
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {isEditing ? (
                          ...
                          <p className={clsx(
                            ...
                            valor ? 'text-gray-900' : 'text-gray-400 italic'
                          )}>
                            {valor || 'No detectado'}
                          </p>
                        )}
